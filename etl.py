...
def process_song_data(spark, input_data, output_data):
    ...
    Parameters - Spark Connection, S3 Bucket link for udacity-dend, S3 Bucket link for my own AWS account respectively sri-data-lake
    Return - None
    '''
...
def process_log_data(spark, input_data, output_data):
    ...
    Parameters - Spark Connection, S3 Bucket link for udacity-dend, S3 Bucket link for my AWS account sri-data-lake
    Return - None
    '''
